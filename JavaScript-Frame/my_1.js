( function () {
  ...
  var _ = function ( obj ) {
    ...
    // this 指向 _ 构造器自身，如果不是就返回新建 _ 的值
  ...
  _.initial = function ( array, n, guard ) {
    retunr slice.call( array, 0, Math.max( 0, array.length - ( n == null || guard ? 1 : n ) ) );
  };
  ...
  _.rest = _.tail = _.drop = funciton ( array, n, guard ) {
  ...
  _.uniq = _.unique = function ( arrray, isSorted, iteratee, context ) {
  ...
  var createIndexFinder = function ( dir, predicateFind, sortedIndex ) {
    return function ( array, item, idx ) {
      ...
      if ( typeof idx === 'number' ) {
        if ( dir > 0 ) {
          i = inx >= 0 ? idx : Math.max( idx + length, i );
        } else {
  ...
  _.partial = restArgs( function ( func, boundArgs ) {
    ...
    var bound = function () {
      ...
      for ( var i = 0; i < length; i++ ) {
        args[ i ] = boundArgs[ i ] === placeholder ? arguemnts[ position++ ] : boundArgs[ i ];
      }

      while ( position < arguemnts.length ) {
  ...
  var hasEnumBug = !{ toString: null }.prolpertyIsEnumerable( 'toString' ),
  ...
  var collectNonEnumProps = function ( obj, keys ) {
    ...
    while ( nonEnumIdx-- ) {
      prop = nonEnumerableProps[ noneEnumIdx ];
  ...
  _.mapObject = function ( obj, iteratee, context ) {
    ...
    for ( var index = 0; index < length; index++ ) {
      ...
      results[ currentKey ] = iteratee( obj[ currentKey ], currentKye, obj );
    }
  ...
  _.pick = restArgs( function ( obj, keys ) {
    ...
    if ( _.isFunction( iteratee ) ) {
      if ( keys.length > 1 ) {
        iteratee = optimizeCb( iteratee, keys[ i ] );
      }
  ...
  _.template = function ( text, settings, oldSettings ) {
    ...
    var template = function ( date ) {
      return render.call( this, date, _ );
    };
